                ...
                <div className="tab-content" id="setting-content">
                    <div className="tab-pane fade show active scroll-wrapper" id="todo-section" role="tabpanel" aria-labelledby="todo-section">
                        ...
                        <div className="events pt-4 px-3">
                            <div className="wrapper d-flex mb-2">
                                <i className="ti-control-record text-primary mr-2" />
                                <span>No Sales or events yet</span>
                            </div>
                            <p className="mb-0 font-weight-thin text-gray">Current sales or offers will appear here</p>
                            {/* <p className="text-gray mb-0 ">Call Sarah Graves</p> */}
                        </div>
                    ...
                    <div className="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
                        <div className="d-flex align-items-center justify-content-between border-bottom">
                            <p className="settings-heading border-top-0 mb-3 pl-3 pt-0 border-bottom-0 pb-0">Offers for you</p>
                            <small className="settings-heading border-top-0 mb-3 pt-0 border-bottom-0 pb-0 pr-3 font-weight-normal"> All</small>
                        </div>
                        <ul className="chat-list">

                            <li className="list active">
                                <div className="profile"> <i className="fa-solid fa-2x mt-1 fa-user" />
                                    {/* <img src="images/faces/face1.jpg" alt="image" /> */}
                                    &nbsp;<span className="online" /></div>
                                <div className="info">
                                    <p>Nothing here</p>
                                    <p>You'll see latest info here</p>
                                </div>
